 ...
 * model</a>.
 *
 * The type mapping is pre-computed and dumped on disk in the {@link *
 * MapBuilder} class, then it is loaded in-memory here using <a
 * href="http://fastutil.di.unimi.it/">fastutil</a> LongBigList. To be
