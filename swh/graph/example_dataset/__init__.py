...
swh.graph example dataset
=========================

This synthetic dataset is made of only a very tiny number of objects.
Any real-world input for the Software Heritage software stack is likely
to be orders of magnitude bigger. However, it is small enough to be
easily comprehensive for human beings. This makes it useful for exploring
the behavior of ``swh.graph`` or  writing tests.
...
.. warning::
   ...
   constants in ``swh.graph`` test suite given the current implementation.
