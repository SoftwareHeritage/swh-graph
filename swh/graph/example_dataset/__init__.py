...
SENSITIVE_DATASET_DIR: Path = Path(f"{DATASET_DIR}_sensitive")
"""Path to the sensitive dataset directory. For this example dataset it is not actually
sensitive, but the production equivalent is.
